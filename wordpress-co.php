...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style(
        ...
        'https://www.encountercolombiancoffee.com/css/encounter-custom.css',
        ['encounter-bootstrap-icons'],
        '1.0.0'
    );
            ...
            <div class="container">
                <div class="navbar-fixed-row">
                    <div class="navbar-fixed-col navbar-logo-section">
                        <a class="navbar-brand" href="https://www.encountercolombiancoffee.com/index-es.html">
                            <img src="https://www.encountercolombiancoffee.com/images/Home/Logos/Pictograma.png" class="navbar-brand-image" alt="Encounter Colombian Coffee">
                            <img src="https://www.encountercolombiancoffee.com/images/Home/Logos/Pictogramanombre.png" class="navbar-brand-wordmark" alt="Encounter Colombian Coffee">
                        </a>
                    </div>
                    ...
                    <div class="navbar-nav-section" id="encounterStoreNav">
                        <ul class="navbar-nav nav-separated">
                            <li class="nav-item">
                                <img src="https://www.encountercolombiancoffee.com/images/Home/Pictogramas%20home/Pictogramasintento.png" alt="Inicio">
                                <a class="nav-link" href="https://www.encountercolombiancoffee.com/index-es.html">Inicio</a>
                            </li>

                            <li class="nav-item">
                                <img src="https://www.encountercolombiancoffee.com/images/Home/Pictogramas%20home/Pictogramas06.png" alt="Qué hacemos">
                                <a class="nav-link" href="https://www.encountercolombiancoffee.com/what-we-do-es.html">¿Qué hacemos?</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active" href="https://www.encountercolombiancoffee.com/tienda/">Tienda</a>
                            </li>

                            <li class="nav-item ms-3">
                                <span class="encounter-domain-pill">CO <span>.com</span></span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row gy-5 align-items-start">
                    <div class="col-lg-6 col-12 footer-social-block">
                        <h5 class="site-footer-title mb-4">Conéctate con nosotros</h5>
                        <p class="footer-body-text">
                            ¿Quieres contactarnos?<br>
                    ...
                    <div class="col-lg-6 col-12 footer-contact-block">
                        <h5 class="site-footer-title mb-4">Información de contacto</h5>
                        ...
                        <div class="mb-4">
                            <p class="footer-label mb-1"><strong>Sitio web:</strong></p>
                            <a href="https://www.encountercolombiancoffee.com" class="footer-contact-link">encountercolombiancoffee.com</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-bottom-row">
                    <div class="col-12 text-center">
                        <img src="https://www.encountercolombiancoffee.com/images/Home/Logos/logo-footer.png" alt="Encounter Colombian Coffee" class="footer-logo">
                        <p class="copyright-text">Copyright © 2025 Encounter Coffee</p>
                        <ul class="footer-legal-links" aria-label="Documentos legales">
                            <li><a href="https://www.encountercolombiancoffee.com/docs/aviso-de-privacidad.pdf" target="_blank" rel="noopener">Aviso de privacidad</a></li>
                            <li><a href="https://www.encountercolombiancoffee.com/docs/politica-de-cookies.pdf" target="_blank" rel="noopener">Política de cookies</a></li>
                            <li><a href="https://www.encountercolombiancoffee.com/docs/politica-de-tratamiento-de-datos.pdf" target="_blank" rel="noopener">Política de tratamiento de datos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
